...
ActiveRecord::Schema[7.1].define(version: 2025_08_22_031125) do
  ...
  create_table "pdf_materials", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "file_path"
    t.index ["chapter_id"], name: "index_pdf_materials_on_chapter_id"
    t.index ["user_id"], name: "index_pdf_materials_on_user_id"
  end
  ...
  create_table "student_answers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_id"], name: "index_student_answers_on_task_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "allowed_grade"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
  end

  create_table "vector_chunks", force: :cascade do |t|
    t.text "content"
    t.text "embedding"
    t.bigint "chapter_id", null: false
  ...
  add_foreign_key "student_answers", "tasks"
